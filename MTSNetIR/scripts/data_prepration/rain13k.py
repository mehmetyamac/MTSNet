...
for data in args.data.split('-'):
    if data == 'train':
        ...
        shutil.unpack_archive('./datasets/Rain13K/train.zip', './datasets/Rain13K')
        os.remove('./datasets/Rain13K/train.zip')
    ...
    if data == 'test':
        ...
        shutil.unpack_archive('./datasets/Rain13K/test.zip', './datasets/Rain13K')
        os.remove('./datasets/Rain13K/test.zip')
